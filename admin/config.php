...
if(isset($_POST["submit"])){
    ...
    /*$config[$config.length]=array("menu"=>array("Maxakali","Pankararu","Pankararu Pataxó","Krenak","Borum"));/**/
    //var_dump($config);
      ...
      $(function() {
         $("input:file").change(function (e){
           ...
           //reader.onload = function(e) {             
             //$("#preview" + $(this).attr('id')).attr('src', fileName);
             //document.getElementById("preview" + $(this).attr('id')).src=fileName
             //alert(fileName)
           //}           
